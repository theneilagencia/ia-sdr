...
def upgrade() -> None:
    ...
    op.create_index('ix_agent_runs_tenant_created', 'agent_runs', ['tenant_id', 'created_at'], unique=False)
    ...
    sa.Column('qualification_criteria', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    ...
    op.create_index('ix_companies_tenant_created', 'companies', ['tenant_id', 'created_at'], unique=False)
    ...
    op.create_index('ix_knowledge_documents_tenant_created', 'knowledge_documents', ['tenant_id', 'created_at'], unique=False)
    ...
    op.create_index(op.f('ix_usage_events_campaign_id'), 'usage_events', ['campaign_id'], unique=False)
    ...
    op.create_index('ix_usage_events_tenant_kind', 'usage_events', ['tenant_id', 'kind'], unique=False)
    ...
    op.create_index('ix_contacts_tenant_created', 'contacts', ['tenant_id', 'created_at'], unique=False)
    ...
    op.create_index('ix_knowledge_chunks_tenant_created', 'knowledge_chunks', ['tenant_id', 'created_at'], unique=False)
    ...
    op.create_index('ix_research_tenant_created', 'research', ['tenant_id', 'created_at'], unique=False)
    ...
    op.create_index('ix_sequences_tenant_created', 'sequences', ['tenant_id', 'created_at'], unique=False)
    ...
    op.create_index('ix_meetings_tenant_created', 'meetings', ['tenant_id', 'created_at'], unique=False)
    ...
    op.create_index(op.f('ix_qualifications_prospect_id'), 'qualifications', ['prospect_id'], unique=False)
    op.create_index('ix_qualifications_tenant_created', 'qualifications', ['tenant_id', 'created_at'], unique=False)
